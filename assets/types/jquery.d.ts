...
interface JQuery {
    ...
    show(effectName: string, options: any, duration: number, callback: Function);
    effect(effectName: string, options: any, duration: number, callback: Function);
    progressbar(option: any);
    CanvasJSChart(settings: any);
    selectmenu(option: any);

    dialog(typeOfRequest: string, optionName: string, optionValue: any);
